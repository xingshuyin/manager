...
urlpatterns = [
    ...
    # path('list_generic/<int:page>/', views.GenericListApi.as_view(), name='GenericListApi'),
    # path('detail_generic/<str:pk>/', views.GenericDetailApi.as_view(), name='GenericDetailApi'),
    # path('MixinListApi/', views.MixinListApi.as_view(), name='MixinListApi'),
    # path('MixinDetailApi/', views.MixinDetailApi.as_view(), name='MixinDetailApi'),
